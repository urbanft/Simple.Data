namespace Simple.Data
{
    ...
    public class SimpleQuery : DynamicObject, IEnumerable
    {
        ...
        {
            return new SimpleQuery(source: this, clauses: EnumerableExtensions.Append(_clauses.Where(c => !(c is SelectClause)), (new SelectClause(columns))).ToArray());
        }
        ...
        {
            return new SimpleQuery(source:this, clauses: EnumerableExtensions.Append(_clauses.Where(c => !(c is ForUpdateClause)),(new ForUpdateClause(skipLockedRows))).ToArray());
        }
        ...
        {
            return new SimpleQuery(source:this,
                                  clauses: EnumerableExtensions.Append(_clauses.Where(c => !(c is WhereClause)),(new WhereClause(criteria))).ToArray());
        }
